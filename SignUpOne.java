...
//        dateOfBirth.setForeground(Color.black);
        ...
        JComboBox stateCh = new JComboBox(stateArray);
  ...
  //              return;
  //          }
            else if(emailAE.equals("")){
                JOptionPane.showMessageDialog(null, "Email address is required");
                return;
            }
            else if(addressAE.equals("")){
                JOptionPane.showMessageDialog(null, "Address is required");
                return;
            }
            else if(cityAE.equals("")){
                JOptionPane.showMessageDialog(null, "City is required");
                return;
            }
            else if(stateAE.equals("")){
                JOptionPane.showMessageDialog(null, "State is required");
                return;
            }
            else if(pinAE.equals("")){
